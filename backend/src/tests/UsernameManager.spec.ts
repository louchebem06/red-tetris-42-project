...
describe('UsernameManager', () => {
	...
	test.skip('Remove all usernames', (done) => {
		manager.display()
		expect(manager.display()).toBeTruthy()
		for (const user of updates) {
			console.log(user)
			console.log(manager.displayUsername(user.username))
			console.log(manager.displayUsername(user.expected))
			//	expect(manager.displayUsername(user.expected)).toBeTruthy();
			//	expect(manager.removeRecurrence(user.expected)).toBeTruthy()
		}
